            ...
            <div class="side-nav-inner">
                <ul class="side-nav-menu">
                    ...
                    @if(in_array('dashboard', $privileges))
                        <li class="nav-item dropdown {{ request()->is('admin') ? 'open' : '' }}">
                    ...
                    <li class="nav-item dropdown {{ request()->is('admin/edit-ui/*') ? 'open' : '' }}">
                  ...
                  <span class="icon-holder">
                    ...
                    <li class="nav-item dropdown {{ request()->is('admin/product-requests', 'admin/suggestion-requests') ? 'open' : '' }}">
                        <a class="dropdown-toggle" href="#">
                  <span class="icon-holder">
                    <i class="lni-timer"></i>
                  </span>
                    ...
                    <li class="nav-item dropdown {{ request()->is('admin/moderators/*') ? 'open' : '' }}
">
                  ...
                  <span class="icon-holder">
                    ...
                    <i class="lni-chevron-right"></i>
                        ...
                        <ul class="dropdown-menu sub-down[">
                            <li>
                                <a href="{{ route('admin.moderators.create') }}">Add moderator</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.moderators.index') }}">Edit moderator</a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    @if(in_array('translations', $privileges))
                    <li class="nav-item dropdown {{ request()->is('admin/translations') ? 'open' : '' }}">
